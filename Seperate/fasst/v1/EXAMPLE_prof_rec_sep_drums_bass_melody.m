...
[x, fs]=wavread([data_dir file_name]);
x = x.';
mix_nsamp = size(x,2);
...
wavwrite(reshape(i_est(1,:,:),mix_nsamp,2),fs,[results_dir file_name(1:end-4) '__est_melody.wav']);
wavwrite(reshape(i_est(2,:,:),mix_nsamp,2),fs,[results_dir file_name(1:end-4) '__est_drums.wav']);
wavwrite(reshape(i_est(3,:,:),mix_nsamp,2),fs,[results_dir file_name(1:end-4) '__est_bass.wav']);
wavwrite(reshape(i_est(4,:,:),mix_nsamp,2),fs,[results_dir file_name(1:end-4) '__est_other.wav']);
