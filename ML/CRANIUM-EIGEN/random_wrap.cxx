...
#define SWIGTYPE_p_Std__RandomBase swig_types[0]
#define SWIGTYPE_p_Std__RandomKnuth swig_types[1]
#define SWIGTYPE_p_Std__RandomMersenne swig_types[2]
#define SWIGTYPE_p_Std__RandomMersenne64 swig_types[3]
#define SWIGTYPE_p_Std__RandomMinStd swig_types[4]
#define SWIGTYPE_p_Std__RandomRanLux24 swig_types[5]
#define SWIGTYPE_p_Std__RandomRanLux48 swig_types[6]
...
#define SWIG_init      luaopen_random
#define SWIG_init_user luaopen_random_user

#define SWIG_LUACODE   luaopen_random_luacode
...
static int _wrap_RandomMinStd_randint(lua_State* L) {
  ...
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Std::RandomMinStd::randint",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("Std::RandomMinStd::randint",3,"int");
