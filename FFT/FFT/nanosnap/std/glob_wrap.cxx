...
#define SWIGTYPE_p_Glob swig_types[0]
...
#define SWIGTYPE_p_std__vector_iteratorT_std__string_t swig_types[5]
...
#define SWIG_name      "Glob"
#define SWIG_init      luaopen_Glob
#define SWIG_init_user luaopen_Glob_user

#define SWIG_LUACODE   luaopen_Glob_luacode
...
static int _wrap_new_string_vector__SWIG_0(lua_State* L) {
  ...
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::vector< std::string >::vector",2,"std::string const &");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative");
  arg1 = (size_t)lua_tonumber(L, 1);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("new_string_vector",2,SWIGTYPE_p_std__string);
  }
...
static int _wrap_string_vector___setitem(lua_State* L) {
  ...
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("std::vector< std::string >::__setitem",3,"std::string");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&argp3,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("string_vector___setitem",3,SWIGTYPE_p_std__string);
  }
  arg3 = *argp3;
...
static int _wrap_string_vector_push_back(lua_State* L) {
  ...
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::vector< std::string >::push_back",2,"std::string const &");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("string_vector_push_back",2,SWIGTYPE_p_std__string);
  }
...
static int _wrap_string_vector_assign(lua_State* L) {
  ...
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("std::vector< std::string >::assign",3,"std::string const &");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("string_vector_assign",3,SWIGTYPE_p_std__string);
  }
...
static int _wrap_Glob_globs_set(lua_State* L) {
  ...
  SWIG_check_num_args("Glob::globs",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Glob::globs",1,"Glob *");
  if(!SWIG_isptrtype(L,2)) SWIG_fail_arg("Glob::globs",2,"std::vector< std::string > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Glob,0))){
    SWIG_fail_ptr("Glob_globs_set",1,SWIGTYPE_p_Glob);
  }
...
static int _wrap_Glob_globs_get(lua_State* L) {
  ...
  SWIG_check_num_args("Glob::globs",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Glob::globs",1,"Glob *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Glob,0))){
    SWIG_fail_ptr("Glob_globs_get",1,SWIGTYPE_p_Glob);
  }
...
static int _wrap_new_Glob(lua_State* L) {
  ...
  SWIG_check_num_args("Glob::Glob",1,1)
  if(!SWIG_lua_isnilstring(L,1)) SWIG_fail_arg("Glob::Glob",1,"char const *");
  arg1 = (char *)lua_tostring(L, 1);
  result = (Glob *)new Glob((char const *)arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_Glob,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_Glob_rescan(lua_State* L) {
  int SWIG_arg = 0;
  Glob *arg1 = (Glob *) 0 ;
  char *arg2 = (char *) 0 ;
  
  SWIG_check_num_args("Glob::rescan",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Glob::rescan",1,"Glob *");
  if(!SWIG_lua_isnilstring(L,2)) SWIG_fail_arg("Glob::rescan",2,"char const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Glob,0))){
    SWIG_fail_ptr("Glob_rescan",1,SWIGTYPE_p_Glob);
  }
  
  arg2 = (char *)lua_tostring(L, 2);
  (arg1)->rescan((char const *)arg2);
...
static int _wrap_Glob_size(lua_State* L) {
  ...
  SWIG_check_num_args("Glob::size",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Glob::size",1,"Glob const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Glob,0))){
    SWIG_fail_ptr("Glob_size",1,SWIGTYPE_p_Glob);
  }
  
  result = ((Glob const *)arg1)->size();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_Glob___getitem(lua_State* L) {
  int SWIG_arg = 0;
  Glob *arg1 = (Glob *) 0 ;
  size_t arg2 ;
  std::string result;
  
  SWIG_check_num_args("Glob::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("Glob::__getitem__",1,"Glob *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("Glob::__getitem__",2,"size_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Glob,0))){
    SWIG_fail_ptr("Glob___getitem",1,SWIGTYPE_p_Glob);
  }
...
static swig_lua_method swig_Glob_methods[]= {
    { "rescan", _wrap_Glob_rescan},
    { "size", _wrap_Glob_size},
    { "__getitem", _wrap_Glob___getitem},
    {0,0}
};
...
static swig_lua_class _wrap_class_Glob = { "Glob", "Glob", &SWIGTYPE_p_Glob,_proxy__wrap_new_Glob, swig_delete_Glob, swig_Glob_methods, swig_Glob_attributes, &swig_Glob_Sf_SwigStatic, swig_Glob_meta, swig_Glob_bases, swig_Glob_base_names };
...
static swig_type_info _swigt__p_Glob = {"_p_Glob", "Glob *", 0, 0, (void*)&_wrap_class_Glob, 0};
...
static swig_cast_info _swigc__p_Glob[] = {  {&_swigt__p_Glob, 0, 0, 0},{0, 0, 0, 0}};
