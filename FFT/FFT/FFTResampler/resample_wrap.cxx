...
#define SWIGTYPE_p_std__vectorT_float_t swig_types[0]
...
#define SWIG_name      "resample"
#define SWIG_init      luaopen_resample
#define SWIG_init_user luaopen_resample_user

#define SWIG_LUACODE   luaopen_resample_luacode
...
static int _wrap_resampler(lua_State* L) {
  ...
  SWIG_check_num_args("resampler",4,4)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("resampler",1,"std::vector< float > &");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("resampler",2,"uint32_t");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("resampler",3,"std::vector< float > &");
  if(!lua_isuserdata(L,4)) SWIG_fail_arg("resampler",4,"uint32_t");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("resampler",1,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_uint32_t,0))){
    SWIG_fail_ptr("resampler",2,SWIGTYPE_p_uint32_t);
  }
  arg2 = *argp2;
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&arg3,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("resampler",3,SWIGTYPE_p_std__vectorT_float_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&argp4,SWIGTYPE_p_uint32_t,0))){
    SWIG_fail_ptr("resampler",4,SWIGTYPE_p_uint32_t);
  }
  arg4 = *argp4;
  
  resampler(*arg1,arg2,*arg3,arg4);
