libsndfile_1.0.28.dylib precompiled shared lib was downloaded from https://github.com/bastibe/libsndfile-binaries

----------------------------------------------
libsndfile binaries

This repository provides pre-compiled dynamic libraries for libsndfile. The files have no dependencies on other libraries, support for FLAC and Ogg Vorbis is built-in statically.

----------------------------------------------

DLLs for Windows (32-bit and 64-bit)

The DLLs were created on a Debian GNU/Linux system using MXE (this version, using libsndfile-1.0.28.tar.gz) with the following commands (after installing the dependencies):
